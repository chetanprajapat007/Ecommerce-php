...
<div class="card mb-4">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="<?= site_url('admin/leads/export') . (!empty($_SERVER['QUERY_STRING']) ? '?' . $_SERVER['QUERY_STRING'] : '') ?>" class="btn btn-success me-2">
                <i class="fas fa-file-export"></i> Export
            </a>
            <a href="<?= site_url('admin/leads/import') ?>" class="btn btn-info me-2">
    ...
    <div class="card-body">
        <form action="<?= site_url('admin/leads') ?>" method="get">
            <div class="row">
            ...
            <div class="row">
                <div class="col-12 text-end">
                    <a href="<?= site_url('admin/leads') ?>" class="btn btn-secondary me-2">Reset</a>
                ...
                <tbody>
                    <?php foreach ($leads as $lead): ?>
                        <tr>
                            ...
                            <td class="editable" data-field="email" data-id="<?= $lead['id'] ?>">
                                <?= $lead['email'] ?? 'N/A' ?>
                            </td>
                            <td class="editable" data-field="contact_number" data-id="<?= $lead['id'] ?>">
...
<div class="modal fade" id="addLeadModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= site_url('admin/leads/store') ?>" method="post">
                <?= csrf_field() ?>
...
<script>
    $(document).ready(function() {
        ...
        $('.edit-lead').on('click', function() {
            ...
            $.ajax({
                url: '<?= site_url('admin/leads/edit/') ?>' + id,
                type: 'GET',
                dataType: 'json',
                success: function(response) {
                    ...
                    $('#editLeadForm').attr('action', '<?= site_url('admin/leads/update/') ?>' + id);
        ...
        $('.editable').on('dblclick', function() {
            ...
            input.on('blur', function() {
                ...
                $.ajax({
                    url: '<?= site_url('admin/leads/update-field/') ?>' + id,
                    type: 'POST',
                    data: {
                        field: field,
                        value: newValue,
