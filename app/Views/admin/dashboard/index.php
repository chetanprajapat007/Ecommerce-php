        ...
        <form action="<?= site_url('admin/dashboard') ?>" method="get">
            ...
            <div class="row">
                <div class="col-12 text-end">
                    <a href="<?= site_url('admin/dashboard') ?>" class="btn btn-secondary me-2">Reset</a>
    ...
    <div class="col-md-2">
        <div class="card bg-primary text-white">
            <div class="card-body">
                ...
                <a href="<?= site_url('admin/leads?status=new') ?>" class="stretched-link text-white"></a>
            </div>
        </div>
    </div>
    <div class="col-md-2">
        <div class="card bg-warning text-dark">
            <div class="card-body">
                ...
                <a href="<?= site_url('admin/leads?status=followup') ?>" class="stretched-link text-dark"></a>
            </div>
        </div>
    </div>
    <div class="col-md-2">
        <div class="card bg-secondary text-white">
            <div class="card-body">
                ...
                <a href="<?= site_url('admin/leads?status=na') ?>" class="stretched-link text-white"></a>
            </div>
        </div>
    </div>
    <div class="col-md-2">
        <div class="card bg-danger text-white">
            <div class="card-body">
                ...
                <a href="<?= site_url('admin/leads?status=dead') ?>" class="stretched-link text-white"></a>
            </div>
        </div>
    </div>
    <div class="col-md-2">
        <div class="card bg-success text-white">
            <div class="card-body">
                ...
                <a href="<?= site_url('admin/leads?status=interested') ?>" class="stretched-link text-white"></a>
            </div>
        </div>
    </div>
    <div class="col-md-2">
        <div class="card bg-info text-white">
            <div class="card-body">
                ...
                <a href="<?= site_url('admin/leads?status=win') ?>" class="stretched-link text-white"></a>
            </div>
        </div>
    </div>
</div>
                    ...
                    <tbody>
                        <?php foreach ($followUps as $followUp): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= site_url('admin/leads/call/' . $followUp['lead_id']) ?>" class="btn btn-sm btn-success">
                    ...
                    <tbody>
                        <?php foreach ($recentLeads as $lead): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= site_url('admin/leads/call/' . $lead['id']) ?>" class="btn btn-sm btn-success">
                                        <i class="fas fa-phone"></i> Call
                                    </a>
