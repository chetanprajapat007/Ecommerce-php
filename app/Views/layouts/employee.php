...
<head>
    ...
    <title><?= $title ?? 'Employee Panel' ?> - Outbound Call Center Management System</title>
        ...
        <div class="row">
            ...
            <div class="col-md-2 sidebar d-none d-md-block">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= uri_string() == 'employee/leads' ? 'active' : '' ?>" href="<?= site_url('employee/leads') ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.status-card').on('click', function() {
                ...
                window.location.href = '<?= site_url('employee/leads') ?>?status=' + status;
            });
        });
    </script>
