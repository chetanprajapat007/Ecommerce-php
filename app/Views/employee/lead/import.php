        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <a href="<?= site_url('employee/leads/sample-csv') ?>" class="btn btn-info">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= site_url('employee/leads/process-import') ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field() ?>
